"""Limpia datos de ocupacion apartamentos turisticos -> MinIO silver/ibestat/."""
...
MEDIDAS_MAP = {
    ...
    "GRADO_OCUPACION_APARTAMENTO_TURISTICO": "ocupacion_apartamentos_pct",
    "GRADO_OCUPACION_PLAZA_TURISTICA_FIN_SEMANA": "ocupacion_finde_pct",
    "GRADO_OCUPACION_APARTAMENTO_TURISTICO_FIN_SEMANA": "ocupacion_apartamentos_finde_pct",
}
...
def clean(source_path: str, **context) -> str:
    ...
    expected_cols = [
        "ocupacion_plazas_pct", "ocupacion_apartamentos_pct",
        "ocupacion_finde_pct", "ocupacion_apartamentos_finde_pct",
    ]
    ...
    output_path = f"s3://{BUCKET}/{silver_path("ibestat")}ocupacion_apartamentos_turisticos/"
    df.write_delta(
        output_path,
        mode="overwrite",
